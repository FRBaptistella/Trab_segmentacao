...
void draw() {
  ...
  images[0] = loadImage("Pneus.jpg");
  images[1] = loadImage("Quadro.jpg");
  images[2] = loadImage("Banco.jpg");
  images[3] = loadImage("Pedal.jpg");
  images[4] = loadImage("guidao.jpg");
  images[5] = loadImage("guidao2.jpg");
  images[6] = loadImage("pneu2.jpg");
  images[7] = loadImage("banco2.jpg");
